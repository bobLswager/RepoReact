...
function Button(props) {
  ...
  const cambiarPagina3= () =>{
    setPagina(3);
  }
  const cambiarPagina4= () =>{
    setPagina(4);
  }
  ...
  return (
    ...
    <div className='button-container'>
      <button className="button" onClick={cambiarPagina1}>
      ...
      <button className='button' onClick={cambiarPagina2}>
      ...
      <button className='button' onClick={cambiarPagina3}>
      ...
      <button className='button' onClick={cambiarPagina4}>
